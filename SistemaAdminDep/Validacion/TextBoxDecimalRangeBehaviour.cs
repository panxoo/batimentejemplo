...
namespace SistemaAdminDep.Validacion
{
    public class TextBoxDecimalRangeBehaviour : Behavior<TextBox>
    {
        ...
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register("Minimum", typeof(float), typeof(TextBoxDecimalRangeBehaviour), new PropertyMetadata((float)0.0));
        ...
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register("Maximum", typeof(float), typeof(TextBoxDecimalRangeBehaviour), new PropertyMetadata((float)10.0));
        ...
        private bool ValidateText(string text)
        {
            ...
            if (!float.TryParse(text,style,culture, out number))
            {
                return false;
            }
            if (number < Minimum)
